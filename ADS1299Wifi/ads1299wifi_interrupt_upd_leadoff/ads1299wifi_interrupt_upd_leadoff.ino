...
//    ADS1299_REG_CONFIG3_BIASREF_INT);
    ADS_WREG(ADS1299_REGADDR_CONFIG3, 0xE4);

    //Leadoff detection
    ADS_WREG(ADS1299_REGADDR_LOFF, ADS1299_REG_LOFF_AC_LEAD_OFF_FCLK_DIV_2_16|ADS1299_REG_LOFF_24_NA);
    ADS_WREG(ADS1299_REGADDR_LOFF_SENSP, 0xFF);
